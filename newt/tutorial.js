...
tutorial.introduction = function (checkCookie) {
    ...
    intro.setOptions({
        steps: [
            {
                intro:
                    '<h2 style="text-align:center; margin-top: 10px;"><b style="vertical-align:middle; color:#0B9BCD;">Welcome to  </b><img src="app/img/newt-logo.png"> </h2>\n\
...
tutorial.UIGuide = function () {
    ...
    intro.setOptions({
        steps: [
            {
                intro:
                    '<h2 style="text-align:center; margin-top: 10px;"><b style="vertical-align:middle; color: #0B9BCD;">UI Guide</b></h2>\n\
            ...
            },
            {
                ...
                intro:
                    '<p style="font-size:12px; margin:0px;">Menubar</p><hr style="margin: 5px auto;">\n\
            ...
            },
            {
                ...
                intro:
                    '<p style="font-size:12px; margin:0px;">This group is for file operations</p><hr style="margin: 5px auto;">\n\
            ...
            },
            {
                ...
                intro:
                    '<p style="font-size:12px; margin:0px;">This group is for edit operations</p><hr style="margin: 5px auto;">\n\
            ...
            },
            {
                ...
                intro:
                    '<p style="font-size:12px; margin:0px;">This group is for view operations</p><hr style="margin: 5px auto;">\n\
            ...
            },
            {
                ...
                intro:
                    '<p style="font-size:12px; margin:0px;">This group is for highlight operations</p><hr style="margin: 5px auto;">\n\
            ...
            },
            {
                ...
                intro:
                    '<p style="font-size:12px; margin:0px;">This group is for layout operations</p><hr style="margin: 5px auto;">\n\
            ...
            },
            {
                ...
                intro:
                    '<p style="font-size:12px; margin:0px;">This group is for query operations</p><hr style="margin: 5px auto;">\n\
            ...
            },
            {
                ...
                intro:
                    '<p style="font-size:12px; margin:0px;">This group is for getting help</p><hr style="margin: 5px auto;">\n\
                          <p style="font-size:12px; margin:0px;"><b>- Quick Help<br>- About</b></p>',
            },
            {
                element: document.getElementById("sbgn-inspector"),
                intro:
                    '<p style="font-size:12px; margin:0px;">Object Properties</p><hr style="margin: 5px auto;">\n\
            ...
            },
            {
                element: document.getElementById("sbgn-inspector"),
                intro:
                    '<p style="font-size:12px; margin:0px;">Map Properties</p><hr style="margin: 5px auto;">\n\
            ...
            },
            {
                element: document.getElementById("sbgn-inspector"),
                intro:
                    '<p style="font-size:12px; margin:0px;">Palette</p><hr style="margin: 5px auto;">\n\
