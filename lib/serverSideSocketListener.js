...
module.exports.start = function(io,  model){
   ...
   function runCausalPathForAll(dirs, ind){
    ...
    io.sockets.on('connection', function (socket) {
        ...
        socket.on('calculateDemoFolderFilePaths', function(callback){
          const junk = require('junk');

          console.log('in emit');
          var filePaths = [];
          var fillFilePaths = function(dirPath){
            // console.log(readDir.readSync('public/demo/demoFolder'));
          ...
          fillFilePaths( 'public/demo/demoFolder' );
          callback( filePaths );
        });
                ...
                fs.writeFile(("./analysisOut/" + room + '/' + fileName), fileContent, function (err) {
                    if (err) {
                        ...
                        if(willExecute) {
                            ...
                            executeCommandLineProcess(("java -jar './jar/causalpath.jar' ./analysisOut/" + room + " -ws"), function (data) {
