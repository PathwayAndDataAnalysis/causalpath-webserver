...
appUtilities.getActionsToApplyMapColorScheme = function (newColorScheme, scheme_type, self, _cy) {
    ...
    if (scheme_type == 'solid') {
        ...
        actions.push({
            ...
            param: {eles: collapsedChildren, name: 'background-image', valueMap: clearBgImg(collapsedChildren)}
        });
        ...
        for (var nodeClass in mapColorSchemes[newColorScheme]['values']) {
            ...
            if (nodeClass in chiseInstance.elementUtilities.getDefaultProperties()) {
                actions.push({
                    ...
                    param: {class: nodeClass, name: 'background-color', value: classBgColor}
                });
                actions.push({
                    name: "setDefaultProperty",
    ...
    // no need to handle 3D and Gradient color schemes separately
        ...
        actions.push({
            name: "changeData",
            param: {eles: eles, name: 'background-fit', valueMap: mapCovertoBgFit(eles)}
        });
        actions.push({
            name: "changeData",
            param: {eles: eles, name: 'background-position-x', valueMap: mapPercentToPosition(eles, 50)}
        });
        actions.push({
            name: "changeData",
            param: {eles: eles, name: 'background-position-y', valueMap: mapPercentToPosition(eles, 50)}
        });
        actions.push({
            name: "changeData",
            param: {eles: eles, name: 'background-width', valueMap: mapPercentToPosition(eles, 100)}
        });
        actions.push({
            name: "changeData",
            param: {eles: eles, name: 'background-height', valueMap: mapPercentToPosition(eles, 100)}
        });

        // collapsed nodes' style should also be changed, special edge case
        actions.push({
            name: "changeDataDirty",
            param: {eles: collapsedChildren, name: 'background-color', valueMap: collapsedColorIDMap}
        });
        actions.push({
            name: "changeDataDirty",
            param: {eles: collapsedChildren, name: 'background-image', valueMap: collapsedBackgroundImgMap}
        });
        actions.push({
            name: "changeDataDirty",
            param: {eles: collapsedChildren, name: 'background-fit', valueMap: mapCovertoBgFit(collapsedChildren)}
        });
        actions.push({
            name: "changeDataDirty",
            param: {
        ...
        for (var nodeClass in mapColorSchemes[newColorScheme]['values']) {
            ...
            if (nodeClass in chiseInstance.elementUtilities.getDefaultProperties()) {
                ...
                actions.push({
                    name: "setDefaultProperty",
                    param: {class: nodeClass, name: 'background-position-x', value: '50%'}
                });
                actions.push({
                    name: "setDefaultProperty",
                    param: {class: nodeClass, name: 'background-position-y', value: '50%'}
                });
                actions.push({
                    name: "setDefaultProperty",
                    param: {class: nodeClass, name: 'background-image', value: classBgImg}
                });
                actions.push({
                    name: "setDefaultProperty",
