...
var MapTabGeneralPanel = GeneralPropertiesParentView.extend({
    initialize: function () {
        ...
        $(document).on("change", "#arrow-scale", function (evt) {
            ...
            actions.push({
                name: "changeCss", param: {
                    eles: cy.edges(), name: "arrow-scale",
            ...
            if (userAgreed) {
                ...
                setTimeout(function () {
                    $.ajax({
                        ...
                        data: {
                            fileContent: "no-data",
                            message: "The user didn't consent to sharing their file." + "\nError message: " + errorMessage
                        },
                        success: function (data) {
                        },
                        error: function (xhr, options, err) {
